  ...
  return (
    <div id="Unsubscribe" className=""> 
      ...
      <div className="flex flex-col flex-wrap items-center justify-center py-8 ">
          ...
          <form class="w-full max-w-lg">
                  ...
                  <div class="flex flex-wrap -mx-3 ">
                    <div class="w-full px-1">
                      ...
                      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="email" type="email"  placeholder="Doe@email.com"></input>
                    </div>
                  </div>
          ...
          <p className="pl-12 pr-12 mt-14 text-xl leading-8 text-center text-white lg:text-gray-200 lg:font-medium">
              If you have any questions or comments, please visit our Privacy Policy page or write to <a href="mailto:support@Yourwebsite.com">support@Yourwebsite.com</a>
          </p>
      </div>

        <p class="text-white text-center text-lg italic ">Thank you for visiting.</p>
