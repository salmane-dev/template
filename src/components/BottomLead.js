    ...
    <div className="flex flex-col p-4 justify-center bg-blue-800 lg:pt-24 lg:pb-14  bg-cover lg:h-full bg-action2">
      ...
      <div className="flex flex-wrap -mx-3 mb-6">
        <div className="w-full px-3">
          ...
          <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="email" type="email"  placeholder="Doe@email.com"></input>
          {/* <p className="text-gray-200 text-xs italic">Some tips - as long as needed</p> */}
        </div>
      </div>
