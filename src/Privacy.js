...
const Privacy = ({sitename}) => {
  const style_paragra = "text-3xl font-bold leading-normal text-center text-white lg:text-3xl lg:pt-10"
  return (
    <div id="Privacy" className=""> 
          <div className="flex flex-col justify-center bg-blue-800 lg:pt-24 lg:pb-14 lg:bg-cover ">
              <p className={style_paragra}> PRIVACY POLICY</p>
              <p className={style_paragra}> of</p>
              <p className={style_paragra}>  {sitename} and all related Websites.</p>
