...
const Privacy = ({appType, tagLine, description, mainActionText, extraActionText}) => {
  return (
    <div id="Privacy" className=""> 
      ...
      <p className="text-3xl font-bold leading-normal text-center text-white lg:text-3xl lg:pt-10"> Viewpointclub.com and all related Websites.</p>
